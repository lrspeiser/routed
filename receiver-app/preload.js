...
const ALLOW_INVOKE = new Set([
  ...
  'scripts:list','scripts:create','scripts:execute','scripts:delete','scripts:get','scripts:update',
  'scripts:enableToggle','scripts:runNow','scripts:test','scripts:logs:tail','scripts:logs:read',
  'scripts:logs:clear','scripts:webhook:url','scripts:ai:generate',
  'debug:log',
